...
"""
    ...
    def _cleanup_wlan0_dnsmasq(self):
        ...
        port conflicts (Address already in use on port 53/67).
        ...
        try:
            ...
            # Check if except-interface=wlan0 is already active (uncommented)
            ...
            # Add except-interface=wlan0 if missing
            if not has_except:
                # Remove any existing line first (idempotent), then append
                subprocess.run(
