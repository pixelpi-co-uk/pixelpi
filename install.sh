...
# Install hostapd service override for WiFi AP IP assignment
mkdir -p /etc/systemd/system/hostapd.service.d
cp systemd/hostapd.service.d/ip-assignment.conf /etc/systemd/system/hostapd.service.d/
...
echo "WiFi AP IP assignment will run when hostapd starts"
